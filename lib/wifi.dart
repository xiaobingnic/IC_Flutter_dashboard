...
const String STA_DEFAULT_SSID = "INT-PB-3278-2";
const String STA_DEFAULT_PASSWORD = "t0uchFr33";
...
class _FlutterWifiIoTState extends State<FlutterWifiIoT> {
  ...
  Widget build(BuildContext poContext) {
    return MaterialApp(
      title: Platform.isIOS ? "Wifi iOS" : "Wifi Android",
      home: Scaffold(
        appBar: AppBar(
          title: Platform.isIOS ? Text('Wifi iOS') : Text('Wifi Android'),
