...
class ManualDocPage extends StatefulWidget {
  @override
  _ManualDocPageState createState() => new _ManualDocPageState();
}

class _ManualDocPageState extends State<ManualDocPage> {
